...
<img
  src={"https://miro.medium.com/v2/resize:fit:720/format:webp/1*eYzE_8Ng1zvftXJVSdd8UA.png"}
  width={700}
  height={700}
  alt={`introduction-main`}
  priority={true}
/>
...
> If Sourcecred sounds as mysterious as a ghost in your attic, I recommend checking out <Link href="https://www.youtube.com/watch?v=yVTqRLekRl4" target="_blank"> [Dandelion's 20-minute talk from SustainWeb3]()</Link>. It's like the ultimate beginner's guide.
...
If you would like to dive deeper into the mechanics of Sourcecred, we highly encourage reading <Link href="https://research.protocol.ai/blog/2020/sourcecred-an-introduction-to-calculating-cred-and-grain/" target="_blank"> [this article]() </Link> from Evan Miyazono where goes in detail about Markov Chains, Stationary Distributions and all that jazz.
...
<img
  src={"https://media.licdn.com/dms/image/C4D12AQHDzO6N5xnqbw/article-cover_image-shrink_720_1280/0/1650719318434?e=2147483647&v=beta&t=uxW9_ZKqzZTa5OfLY_h9fQyK5Gvh8VjZy9Q5xUwswdU"}
  width={700}
  height={700}
  alt={`introduction-main`}
  priority={true}
...
Armitage is a living project, and it plans to evolve over time through its community. We firmly believe in open source software, and we definetely love the idea of <Link href="https://www.nytimes.com/2022/11/14/business/dogfooding.html#:~:text=In%20the%20world%20of%20tech,what%20needs%20to%20be%20fixed" target="_blank"> [dogfooding]() </Link> :)
