...
export function GenerateAttestationModal({
  ...
  const [registeredAttestationUuid, setRegisteredAttestationUuid] = useState<string | undefined>(
    undefined,
  );
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            You will be prompted to sign a message and broadcast it to create your attestation
          </DialogDescription>
        </DialogHeader>
          ...
          {registeredAttestationUuid
            ? (
              <div>
                ...
                <div className="pt-6">
                  <Link href={`https://sepolia.easscan.org/attestation/view/${registeredAttestationUuid}`}>
                    <Button
                      variant={"outline"}
                      onClick={() => {
                      }}
