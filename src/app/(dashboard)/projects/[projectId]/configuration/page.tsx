...
export default function ProjectConfigurationPage({ params }: PageProps) {
  ...
  const breadcrumbItems = [
    ...
    { title: "Project Config", link: `/projects/${teamId}/config` },
  ];
      ...
      <div className="flex-1 space-y-4  p-4 md:p-8 pt-6">
        ...
        <div className="pt-6 leading-7 [&:not(:first-child)]:mt-6">
          <Alert>
            ...
            <AlertTitle>Customize your project weights</AlertTitle>
            <AlertDescription>
              Measure contributions by adjusting sliders to align with your
